    ...
    <div class="container py-4 py-xl-5">
        <div class="row justify-content-center">
            ...
            <div class="col-12">
                ...
                <div class="mb-3">
                    <a href="{{ route('teacher#dashboard') }}" class="btn btn-sm btn-link text-secondary fw-medium p-0">
                ...
                <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
                    <h2 class="fw-bold text-dark m-0 fs-4"> My Created Courses</h2>
                    {{-- Button made smaller and cleaner --}}
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-4 mb-3 mb-md-0">
                                <span class="text-muted small fw-medium">Total Courses:
                                    {{ $courses->count() ?? 'N/A' }}</span>
                            </div>

                            {{-- Search Bar/Filter (Longer and Centered in the remaining space) --}}
                            <div class="col-md-8">
                                <form action="{{ route('teacher#myCourses') }}" method="GET" class="d-flex ms-auto">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($courses as $item)
                                        <tr>
                                            ...
                                            <td><span
                                                    class="badge bg-secondary-subtle text-secondary fw-medium p-2 text-uppercase rounded-pill">{{ $item->price }}$</span>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center pe-4">
                                                <div class="btn-group btn-group-sm" role="group">
                                                    ...
                                                    {{-- Edit Button (Smaller) --}}
                                                    <a href="{{ route('teaceher#editCourse', $item->id) }}"
                                                        class="btn btn-outline-primary border-0" title="Edit Course">
