...
<head>
    ...
    <title>Register - Taxila Academy</title>
        ...
        <div class="auth-left">
            ...
            <div class="auth-content">
                ...
                <div class="branding">
                    ...
                    <p class="brand-subtitle">Start your learning journey today and unlock endless possibilities.</p>
                </div>
                <div class="auth-features">
                    <div class="feature-item">
                        <i class="bi bi-check-circle-fill"></i>
                        <span>Free Access to 10+ Courses</span>
                    </div>
                    <div class="feature-item">
                        <i class="bi bi-check-circle-fill"></i>
