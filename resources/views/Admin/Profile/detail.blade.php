                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                    <div class="card-header bg-white border-bottom border-light py-3 px-4">
                        <h5 class="m-0 fw-bold text-primary">
                            <i class="fa-solid fa-user-gear me-2"></i>Profile Details
                        </h5>
                    </div>
                        ...
                        <form action="{{ route('account#update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control bg-light border-0 py-2 rounded-3 text-muted"
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="address" rows="3"
                                        ...
                                        placeholder="Enter full address">{{ old('address', Auth::user()->address) }}</textarea>
                                    @error('address')
                                        <small class="invalid-feedback">{{ $message }}</small>
                                    @enderror
                                </div>
