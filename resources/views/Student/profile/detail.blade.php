                ...
                <div class="card border-0 shadow-sm rounded-4 overflow-hidden">
                    <div class="card-header bg-white border-bottom border-light py-3 px-4">
                        <h5 class="m-0 fw-bold text-primary">
                            <i class="fa-solid fa-user-graduate me-2"></i>Student Profile Details
                        </h5>
                    </div>

                    <div class="card-body p-4">
                        <form action="{{ route('student#ProfileUpdate') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="d-flex align-items-center gap-4 mb-5 flex-wrap">
                                ...
                                <div class="flex-grow-1">
                                    <p class="mb-2 fw-bold text-dark">Profile Image</p>
                                    ...
                                    @enderror
                                    <p class="text-muted small mt-2 mb-0">Max Size: 2MB (JPG or PNG)</p>
                                </div>
                            </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" name="email"
                                        ...
                                        placeholder="yourname@example.com" value="{{ old('email', Auth::user()->email) }}">
                                    @error('email')
                                        <small class="invalid-feedback">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="number" name="phone"
                                        ...
                                        placeholder="09..." value="{{ old('phone', Auth::user()->phone) }}">
                                    @error('phone')
                                        <small class="invalid-feedback">{{ $message }}</small>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-control bg-light border-0 py-2 rounded-3 text-muted">
                                        <i class="fa-solid fa-id-badge me-2"></i>{{ ucfirst(Auth::user()->role) }}
                                    </div>
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="address" rows="3"
                                        ...
                                        placeholder="Enter your full home address">{{ old('address', Auth::user()->address) }}</textarea>
                                    @error('address')
                                        <small class="invalid-feedback">{{ $message }}</small>
                                    @enderror
                                </div>
